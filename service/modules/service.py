raise ImportError(
    "service.modules.service is removed — import from service.Modules.service instead:\n"
    "from service.Modules.service import EV3Service"
)
"""
E.V3 Modules Service
Background service that coordinates all components (renamed from service/core)
"""
